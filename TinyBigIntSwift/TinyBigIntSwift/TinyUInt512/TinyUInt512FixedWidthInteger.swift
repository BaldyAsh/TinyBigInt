...
//        result: {(BIT1,BIT2) (BIT2,BIT3,BIT4)} {(BIT4,BIT5,BIT6) (BIT6,BIT7)}
    ...
    internal func quotientAndRemainderFullWidth(dividingBy dividend: (high: TinyUInt512, low: TinyUInt512)) -> (quotient: TinyUInt512, remainder: TinyUInt512) {
        ...
        let divisor = self
        var numeratorLength: TinyUInt512
        
        if dividend.high > 0 {
            numeratorLength = dividend.high.significantBits + 512 - 1
    ...
    internal static func bitFromPosition(at bitPosition: TinyUInt512, for input: (high: TinyUInt512, low: TinyUInt512)) -> TinyUInt512 {
        switch bitPosition {
        case 0:
            return input.low & 1
        case 1...511:
